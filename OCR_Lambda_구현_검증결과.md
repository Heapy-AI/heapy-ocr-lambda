...
최신 배포 검증: 2026-09-08 Actions 34178191058 성공. 커밋 bda032b의 테스트·Linux 빌드·
OIDC 인증·ECR 업로드·Worker 및 Janitor 버전 2 발행과 live 전환 후 스모크가 통과했다.
개발 자동 배포는 활성화했으며 운영은 미활성이다. 아래 미배포 기록은 이전 이력이다.
...
이전 56개·Linux CI 기록은 해당 코드 시점의 결과이며 이번 AWS 재생성 성공을 뜻하지 않는다.
